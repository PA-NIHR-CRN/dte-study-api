...
public class DevAuthenticationService : IAuthenticationService
{
    ...
    public DevAuthenticationService(IAmazonCognitoIdentityProvider provider, IHeaderService headerService,
        AwsSettings awsSettings, ILogger<DevAuthenticationService> logger, IEmailService emailService,
        IParticipantService participantService, IOptionsMonitor<DevSettings> devSettings,
        IContentfulService contentfulService, ContentfulSettings contentfulSettings,
        IMockIdentityService mockIdentityService, IUserService userService)
