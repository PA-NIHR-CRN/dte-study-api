...
namespace ParticipantApi.Acceptance.Tests.Stubs
{
    public class ParticipantRepositoryStub : IParticipantRepository
    {
        ...
        public Task<ParticipantDetails> ScanForParticipantDetailsWithFilterAsync(string dbCol, AttributeValue filterValue)
        {
            return Task.FromResult(_participantDetails.FirstOrDefault(x => x.Email == filterValue.S));
        }
    }
}