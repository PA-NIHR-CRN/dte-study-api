...
public class ParticipantDbContext : DbContext
{
    ...
    public DbSet<FilterHasLongTermCondition> FilterHasLongTermCondition { get; set; } = null!;
    ...
    public DbSet<StudyStatusHistory> StudyStatusHistory { get; set; } = null!;
    public DbSet<StudyStatusReasonHistory> StudyStatusReasonHistory { get; set; } = null!;
    ...
    public DbSet<RejectedReason> SysRefRejectedReason { get; set; } = null!;
    public DbSet<StudyStatus> SysRefStudyStatus { get; set; } = null!;
    public DbSet<WithdrawnReason> SysRefWithdrawnReason { get; set; } = null!;
